$(document).ready(function () {
    function ckEditor(name) {
        var editor = CKEDITOR.replace(name, {
            language: 'vi',
            filebrowserBrowseUrl: baseUrl + 'editor/ckfinder/ckfinder.html',
            ...
            filebrowserUploadUrl: baseUrl + 'editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
